...
export class CreateTemplateDto {
  ...
  @ApiPropertyOptional({ description: 'Extra media for mixed template (text+photo+video+file together)' })
  @IsOptional()
  extraMedia?: Record<string, any>;

  @ApiPropertyOptional({ description: 'Wapp Btn buttons: [{type: url|call, text, value}] - url=https://..., call=10 digit Indian', example: [{type:'url', text:'Visit Now', value:'https://mycompany.com'}, {type:'call', text:'Call Now', value:'9876543210'}] })
  @IsOptional()
...
export class UpdateTemplateDto {
  ...
  @ApiPropertyOptional({ description: 'Extra media for mixed template' })
  @IsOptional()
  extraMedia?: Record<string, any>;
...
export class TemplateResponseDto {
  ...
  extraMedia?: Record<string, any> | null;
