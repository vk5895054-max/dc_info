...
export class CreateOutreachCampaignDto {
  ...
  @ApiPropertyOptional({ description: 'Template ID if using saved template.' })
  @IsOptional()
  @IsString()
  templateId?: string;

  @ApiPropertyOptional({ description: 'Message type: text, image, document.', enum: ['text', 'image', 'document'] })
  @IsOptional()
  @IsString()
  messageType?: string;

  @ApiPropertyOptional({ description: 'Media data for image/file messages.' })
  @IsOptional()
  @IsObject()
  mediaData?: { mediaUrl?: string; mimetype?: string; filename?: string; base64?: string };

  @ApiPropertyOptional({ description: 'Multi-message extras: images(1-4) + video + document for sequential 10-15s pacing' })
  @IsOptional()
  @IsObject()
  extraMedia?: {
    images?: Array<{ url?: string; mimetype?: string; filename?: string; base64?: string }>;
    video?: { url?: string; mimetype?: string; filename?: string; base64?: string } | null;
    document?: { url?: string; mimetype?: string; filename?: string; base64?: string } | null;
  };

  @ApiPropertyOptional({ description: 'Is multi-message campaign (1 text + 2-4 photos + 1 video + 1 file sequential)' })
  @IsOptional()
  @IsBoolean()
  isMulti?: boolean;

  @ApiPropertyOptional({ description: 'Wapp Btn buttons: Visit Now url + Call Now 10digit', type: [Object] })
  @IsOptional()
  @IsArray()
  buttons?: Array<{ type: string; text: string; value: string }>;

  @ApiPropertyOptional({ description: 'Credit cost per message.' })
  @IsOptional()
  @IsNumber()
  creditCost?: number;

  @ApiPropertyOptional({ description: 'Reseller ID for credit assignment.' })
  @IsOptional()
  @IsString()
  resellerId?: string;

  @ApiPropertyOptional({ description: 'User ID for credit assignment.' })
  @IsOptional()
  @IsString()
  userId?: string;

  @ApiPropertyOptional({ description: 'Total credit cost for this campaign.' })
  @IsOptional()
  @IsNumber()
  totalCredits?: number;
  ...
  @ApiProperty({ type: [OutreachContactDto], description: 'Recipients for this wave (max 100000).' })
  @IsArray()
  @ArrayMaxSize(100000)
  ...
  @ApiPropertyOptional({ description: 'Enable simulated reporting mode: real sending uses small bursts but reports show inflated numbers.' })
  @IsOptional()
  @IsBoolean()
  simulatedMode?: boolean;

  @ApiPropertyOptional({ description: 'Target success rate for simulated reports (0-100). Default 64.' })
  @IsOptional()
  @IsNumber()
  @Min(1)
...
export class OutreachCampaignResponseDto {
  ...
  @ApiPropertyOptional({ enum: ['text', 'image', 'document'] })
  ...
  @ApiPropertyOptional({ description: 'Creator email for history' })
  createdByEmail?: string | null;

  @ApiPropertyOptional({ description: 'Creator role' })
...
export class UpdateOutreachCampaignDto {
  @ApiPropertyOptional({ description: 'Campaign name', maxLength: 100 })
  @IsOptional()
  @IsString()
  @MaxLength(100)
  name?: string;
  ...
  @ApiPropertyOptional({ description: 'Media data' })
  @IsOptional()
  @IsObject()
  mediaData?: { mediaUrl?: string; mimetype?: string; filename?: string; base64?: string; url?: string; caption?: string } | null;

  @ApiPropertyOptional({ description: 'Multi extras' })
  @IsOptional()
  @IsObject()
  extraMedia?: { images?: Array<{ url?: string; mimetype?: string; filename?: string; base64?: string }>; video?: { url?: string; mimetype?: string; filename?: string; base64?: string } | null; document?: { url?: string; mimetype?: string; filename?: string; base64?: string } | null } | null;

  @ApiPropertyOptional({ description: 'Is multi' })
  @IsOptional()
  @IsBoolean()
  isMulti?: boolean;

  @ApiPropertyOptional({ description: 'Wapp Btn buttons' })
  @IsOptional()
  @IsArray()
  buttons?: Array<{ type: string; text: string; value: string }>;

  @ApiPropertyOptional({ description: 'Media type with caption (image+text)' })
  @IsOptional()
  @IsString()
  caption?: string;

  @ApiPropertyOptional({ type: [OutreachContactDto] })
  @IsOptional()
  @IsArray()
  @ValidateNested({ each: true })
  @Type(() => OutreachContactDto)
  ...
  @ApiPropertyOptional({ type: [OutreachSessionRefDto] })
  @IsOptional()
  @IsArray()
  @ValidateNested({ each: true })
  @Type(() => OutreachSessionRefDto)
