...
export class OutreachController {
  ...
  @Get(':id/replies')
  @ApiOperation({ summary: 'Campaign replies: incoming messages after campaign start, classified interested / not_interested / other, session-wise' })
  @ApiResponse({ status: 200 })
  replies(@Param('id') id: string) {
    return this.outreach.getCampaignReplies(id);
  }
