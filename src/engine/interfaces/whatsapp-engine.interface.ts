...
export interface MessagingCapability {
  ...
  // Wapp Btn buttons: Visit Now (url) + Call Now (10-digit Indian) — optional, wwebjs implements
  sendButtonsMessage?(chatId: string, text: string, buttons: Array<{ type: string; text: string; value: string }>, media?: MediaInput): Promise<MessageResult>;
}
