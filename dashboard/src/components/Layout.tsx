...
const allNavItems = [
  ...
  { to: '/templates', icon: ClipboardList, key: 'templates' as const, roles: ['admin','super_admin','reseller','user','demo','operator','viewer'] },
  { to: '/wapp-btn', icon: MousePointerClick, key: 'wappBtn' as const, roles: ['admin','super_admin','reseller','user','demo'] },
