...
export const apiKeyApi = {
  ...
  getCreditHistory: (id: string) => request<Array<{ id: string; messageType: string; units: number; balanceAfter: number; createdAt: string }>>(`/auth/api-keys/${id}/credit-history`),
